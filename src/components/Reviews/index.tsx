      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-zinc-600 max-w-2xl mx-auto">
            Avaliações escritas por colegas, parceiros e clientes que acompanharam de perto o impacto do meu trabalho.
          </p>
        </div>

        {/* Grid Masonry (2 colunas) */}
        ...
        {/* Link discreto e integrado, mais próximo do grid (mt-10) e sem linhas de separação */}
